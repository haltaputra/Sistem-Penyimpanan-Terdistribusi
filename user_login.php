...
<body>
    <div class="error-pagewrap">
        <div class="error-page-int">
            ...
            <div class="text-center login-footer">
                <p class="text-muted">Copyright © <?php echo date('Y') ?>. Sistem Penyimpanan Berkas Terdistribusi. Kelompok 8.</p>
            </div>
        </div>   
    </div>
	...
	<body class="hold-transition login-page" style="background:url(gambar/depan/Logoo T Z.jpg)
