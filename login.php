...
<body>
    <div class="error-pagewrap">
        <div class="error-page-int">
            ...
            <div class="text-center login-footer">
                <p class="text-muted">Copyright © <?php echo date('Y') ?>. All rights reserved. Sistem Penyimpanan Berkas Terdistribusi</p>
            </div>
        </div>   
    </div>
	...
	<body class="hold-transition login-page" style="background:url(gambar/depan/Logo T Z.jpg)
